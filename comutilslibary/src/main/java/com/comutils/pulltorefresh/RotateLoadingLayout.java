package com.comutils.pulltorefresh;
...
import com.xq.comutilslibary.R;
...
public class RotateLoadingLayout extends LoadingLayout {
    ...
    private void init(Context context) {
        ...
        mArrowImageView.setImageResource(R.drawable.cu_default_reflesh_loaing);
        
        float pivotValue = 0.5f;    // SUPPRESS CHECKSTYLE
        float toDegree = -180.0f;    // SUPPRESS CHECKSTYLE
    ...
    protected View createLoadingView(Context context, AttributeSet attrs) {
        View container = LayoutInflater.from(context).inflate(R.layout.cu_pull_to_refresh_header2, null);
        return container;
    }
